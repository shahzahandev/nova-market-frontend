      ...
      <div className="grid grid-cols-1 gap-8 sm:gap-10 lg:grid-cols-2 lg:gap-12">
        ...
        <div className="flex flex-col">
          <div className="text-center md:text-start">
            ...
            <h1
              className="mt-2 font-display text-2xl font-bold leading-tight sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl"
            >
              {product.title}
            </h1>
          ...
          <div className="mt-6 flex gap-3">
            <button
              ...
              className="flex min-h-14 flex-1 items-center justify-center
                bg-ink
                px-4 py-4 text-lg font-semibold text-white transition hover:bg-ink/90 disabled:cursor-not-allowed
                disabled:opacity-50 sm:min-h-16 sm:text-xl md:py-6 md:text-2xl lg:py-7"
            >
              {product.stock === 0 ? "Out of Stock" : "Get it"}
            </button>
          </div>
