...
//   // Specifications: dynamic [{ name, value }]
...
//     );
//   };
//   const addSpecRow = () => setSpecifications((prev) => [...prev, { name: "", value: "" }]);
...
//       payload.append("specifications", JSON.stringify(cleanSpecs));

//       images.forEach((file) => payload.append("photos", file));
...
//           <div className="sm:col-span-2">
//             <label className="mb-2 block text-sm font-medium text-black">Short Description</label>
//             <textarea
...
//           <div>
//             <label className="mb-2 block text-sm font-medium text-black">Sub Category</label>
//             <input
//               type="text"
//               name="subCategory"
...
//           <div>
//             <label className="mb-2 block text-sm font-medium text-black">Tag</label>
//             <input
//               type="text"
//               name="tag"
//               value={formData.tag}
...
//           <div className="sm:col-span-2">
//             <label className="mb-2 block text-sm font-medium text-black">
//               Features <span className="text-black/40">(comma separated)</span>
//             </label>
//             <input
//               type="text"
//               name="features"
...
//               onChange={handleChange}
//               placeholder="e.g. 45ms low latency, IPX5 water resistant, Touch controls"
//               className="h-12 w-full rounded-lg border border-black/20 px-4 text-sm outline-none transition focus:border-sky-400 focus:ring-2 focus:ring-sky-100"
//             />
//           </div>
...
//               <h3 className="text-base font-semibold text-black">Specifications</h3>
//               <button
//                 type="button"
//                 onClick={addSpecRow}
...
//                     className="h-11 flex-1 rounded-lg border border-black/20 px-3 text-sm outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100"
//                   />
//                   <input
//                     type="text"
//                     value={spec.value}
...
//                     className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg border border-black/10 text-black/40 hover:text-red-600"
//                   >
//                     <Trash2 size={16} />
//                   </button>
//                 </div>
...
//               <div>
//                 <label className="mb-2 block text-sm font-medium text-black">Discount Type</label>
//                 <select
//                   value={discountType}
...
//               <div>
//                 <label className="mb-2 block text-sm font-medium text-black">Sale price preview</label>
...
//               <div>
//                 <label className="mb-2 block text-sm font-medium text-black">Discount start date</label>
//                 <input
//                   type="date"
...
//               <div>
//                 <label className="mb-2 block text-sm font-medium text-black">Discount end date</label>
//                 <input
//                   type="date"
...
//               <label className="block text-sm font-medium text-black">Product Photos</label>
...
//                 {images.length >= MAX_IMAGES ? "Maximum photos reached" : "Click to upload photos"}
//               </span>
//               <input
//                 type="file"
//                 accept="image/*"
...
//                       mainIndex === i ? "border-sky-400" : "border-black/10"
//                     }`}
//                   >
